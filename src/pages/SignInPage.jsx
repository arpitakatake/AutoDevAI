...
import { ArrowRight, Lock, Mail, AlertCircle, Check } from 'lucide-react';
import { useAuth } from '../context/AuthContext.jsx';
import ThemeToggle from '../components/ThemeToggle.jsx';

export default function SignInPage() {
  const [email, setEmail] = useState('alex@autodevai.com');
        ...
        <Link to="/" className="brand-logo">
          <div className="brand-icon">
            <svg width="24" height="24" viewBox="0 0 28 28" fill="none">
              <path d="M14 3L4 21H10L14 13L18 21H24L14 3Z" fill="url(#s-in-1)" />
              <path d="M14 13L10 21H18L14 13Z" fill="url(#s-in-2)" />
              <defs>
                <linearGradient id="s-in-1" x1="4" y1="3" x2="24" y2="21" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#4F46E5" />
                  <stop offset="1" stopColor="#6366F1" />
                </linearGradient>
                <linearGradient id="s-in-2" x1="10" y1="13" x2="18" y2="21" gradientUnits="userSpaceOnUse">
        ...
        >
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            ...
            <p style={{ fontSize: '0.9375rem', color: 'var(--text-secondary)' }}>
              Sign in to continue building with AutoDevAI.
            </p>
          </div>
          ...
          >
            ...
            <Link to="/sign-up" style={{ color: 'var(--accent-primary)', fontWeight: 600 }}>
              Create one
            </Link>
          </p>
        </div>
